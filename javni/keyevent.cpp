...
//  Tabela nije potpuna
//---------------------------------------------------------------------------//
char keymap[128] = { 0, 27, '1', '2', '3', '4', '5', '6', '7', '8', '9', '0',
		'-', '=', 8, 9, 'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p', '[',
		']', 13, 0, 'a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', ';', 0, 0, '`',
		'\\', 'z', 'x', 'c', 'v', 'b', 'n', 'm', ',', '.', '/', 0, '*', 0, ' ' };

//---------------------------------------------------------------------------//
KeyboardEvent::KeyboardEvent(BoundedBuffer* bb) :
		Thread(), myBuffer(bb) {
	theEnd = 0;
}
...
void KeyboardEvent::run() {
	...
	while (!theEnd) {
//		lock();
//		cout << "ceka taster" << endl;
//		unlock();
		event9.wait();
//		lock();
//		cout << "pritisnut taster" << endl;
//		unlock();
	do {
